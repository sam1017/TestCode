...
public class PanoramaSwitchBarView extends GLView implements SwitchBarView {
    ...
    private static final float GAP_PERCENT_OF_SCREEN_HEIGHT = 0.1f;
    ...
    public PanoramaSwitchBarView(Activity activity) {
        ...
        if (actionbar != null && actionbar.getHeight() != 0) {
            ...
            if (theme != null && theme.resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
                ...
                // set heightPixels * GAP_PERCENT_OF_SCREEN_HEIGHT as default gap
                mSwitchBarTopGap = (int) (metrics.heightPixels * GAP_PERCENT_OF_SCREEN_HEIGHT);
    ...
    private class SwitchButton {
        ...
        public SwitchButton(int name, Context context, int focusResID, int normalResID,
                int gapH, int gapV) {
            mName = name;
            ...
            mVisible = true;
            mContentRect = new Rect(0, 0, mFocusTexture.getWidth() + mGapH * 2,
                    mFocusTexture.getHeight() + mGapV * 2);
        }
