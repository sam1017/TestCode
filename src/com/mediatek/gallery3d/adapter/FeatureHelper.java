    ...
    public static Uri tryContentMediaUri(Context context, Uri uri) {
        ...
        try {
            ...
            cursor = Media.query(context.getContentResolver(),
                    ...
                    Media._ID, Media.MIME_TYPE, Media.BUCKET_ID, FileColumns.MEDIA_TYPE }, "_data=(?)",
            ...
            if (null != cursor && cursor.moveToNext()) {
                ...
                //            + ", mediatype isn't FileColumns.MEDIA_TYPE_IMAGE, return uri " + uri);
                //    return uri;
                //}

                // transsion begin, IB-02533, xieweiwei, add, 2016.09.14
                if (mimeType == null) {
                    MtkLog.i(TAG, "<tryContentMediaUri> id = " + id + ", mimeType = " + mimeType
