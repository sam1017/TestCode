...
public class GalleryUtils {
    ...
    public static void initialize(Context context) {
        ...
        FeatureConfig.sIsLowRamDevice = ((ActivityManager) context.getSystemService("activity"))
                .isLowRamDevice();
    ...
    public static long cleatHour(long time) {
	...
	public static boolean supportDivideScreenAndOpened(Context mActivity) {
