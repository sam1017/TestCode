...
class LocalSource extends MediaSource {
    ...
    private static final int LOCAL_MIX_ALBUM = 8;//add by liangchangwei 
    ...
    public LocalSource(GalleryApp context) {
        ...
        mMatcher.add("/local/mixalbum/*", LOCAL_MIX_ALBUM);
    ...
    public MediaObject createMediaObject(Path path) {
        ...
        switch (mMatcher.match(path)) {
            ...
            case LOCAL_MIX_ALBUM:
                return new MixAlbum(mApplication, path);
