...
import com.mediatek.galleryframework.gl.MGLES20Canvas;
...
//            source.bottom = (float) (height - 1) / texHeight;
    ...
    public void deleteRecycledResources() {
        ...
        /// M: [FEATURE.ADD] @{
        if (mMGLCanvas != null) {
            mMGLCanvas.deleteRecycledResources();
        }
        /// @}
    }
...
//        }
    ...
    public MGLCanvas getMGLCanvas() {
        if (mMGLCanvas == null) {
            mMGLCanvas = new MGLES20Canvas();
            mMGLCanvas.setGenerator((Generator) mGLId);
        }
        mMGLCanvas.syncState(mMatrices, mCurrentMatrixIndex, mProjectionMatrix,
                mWidth, mHeight, mScreenWidth, mScreenHeight, getAlpha());
        return mMGLCanvas;
    }
