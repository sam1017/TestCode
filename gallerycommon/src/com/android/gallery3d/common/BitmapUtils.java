...
public class BitmapUtils {
    ...
    public static boolean isSupportedByRegionDecoder(String mimeType) {
        ...
        /// M: [FEATURE.MODIFY] bmp support RegionDecoder @{
        /*return mimeType.startsWith("image/") &&
         (!mimeType.equals("image/gif") && !mimeType.endsWith("bmp"));*/
        // may be some uri image mimetype be similar to "image/vnd.wap.wbmp"
        return mimeType.startsWith("image/") && !mimeType.endsWith("gif")
                && !mimeType.endsWith("mpo") && !mimeType.endsWith("wbmp");
        /// @}
    }
    ...
    private static final int PNG_BACKGROUND_COLOR = 0xFF000000;
    public static Bitmap clearAlphaValueIfPng(Bitmap bitmap, String mimeType, boolean recycleInput) {
        if ("image/png".equals(mimeType)) {
            return BitmapUtils.replaceBackgroundColor(bitmap, PNG_BACKGROUND_COLOR, recycleInput);
        } else {
            return bitmap;
        }
    }
