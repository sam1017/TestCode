...
public class PanoramaPlayer extends Player {
    ...
    private static final int PLACE_HOLDER_COLOR = 0x1A1A1A;
    ...
    public int getOutputWidth() {
        if (mCurrentMode == PANORAMA_MODE_3D) {
            ...
            if (mMediaData.orientation == DEGREE_90 || mMediaData.orientation == DEGREE_270) {
    ...
    private void newPlaceHolderTexture() {
        ...
        mColorTexture = new PanoramaTexture(PLACE_HOLDER_COLOR, config,
                mMediaData.orientation);
    }
}