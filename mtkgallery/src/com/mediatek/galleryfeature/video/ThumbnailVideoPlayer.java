                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            MtkLog.v(TAG, "set surface after releasing player. ignore it");
                        } catch (IllegalArgumentException e) {
                            // this catch block can be avoided by expanding
                            // the monitoring range of textureStateObject
                            MtkLog.v(TAG, "set surface after releasing surface. ignore it");
                        }
                    }
                }).start();
