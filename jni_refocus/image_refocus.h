...
private:
    ...
    /* Refocus global*/
    MUINT8 *pWorkingBuffer = NULL;
    MUINT8 *p_targetImgBuffer = NULL;
    MUINT8 *p_jpsImgBuffer = NULL;
    ...
    bool yv12ToJpg(unsigned char *srcBuffer, int srcSize, int srcWidth, int srcHeight, unsigned char *dstBuffer,
            int dstSize, MUINT32 &u4EncSize);
...
public:
    ...
    bool initRefocusNoDepthMapRealFileTest(const char *testSourceFilePath, const char *sourceFilePath,
